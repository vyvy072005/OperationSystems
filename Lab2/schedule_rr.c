...
void add(char *name, int priority, int burst) {
    ...
    insert_tail(&head, newTask); // Добавляем в конец очереди
}

// Функция для выбора следующей задачи (RR)
